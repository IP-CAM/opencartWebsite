...
<h3 id="specialh3">Our Location</h3>
<div class="panel panel-default" style="width:69%; margin: auto">
  <!-- <div class="panel-body">
    ...
    <div class="row">
        <div class="col-sm-3"><strong>Evolve Auto</strong><br>
    <address>
    185 Bullock Dr., Unit 10<br>
Markham, ON L3P 7R4        </address>
          </div>
...
<?php } ?>
<form style="width:69%; margin: auto "action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
  <fieldset>
    <legend style="color:white; padding-top:20px;   display:block; "><?php echo $text_contact; ?></legend>
