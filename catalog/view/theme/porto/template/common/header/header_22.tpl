...
<header id="header2" class="header1 fixed-header header22">
    <div id="header-inner">   
 ...
 <?php } ?>
            ...
            <header id="header" class="header1 header22" >
				<div>
                    ...
                    <div class="container">
                        <div class="header-left">
                            <!-- <div class="switcher-wrap">
								...
								<span style="font-size:16px" >Wechat: Evolve123 Phone: (647)-123 4567</span>	
<!-- 								
                            </div>End .swticher-wrap -->
                            
                        </div><!-- End .header-left -->
                        <div class="header-right" id= "hour">
							...
							<span style = "font-size:16px"> Monday-Friday 10:00am-5:00pm</span>
                        </div><!-- End .header-left -->
                    </div><!-- end .container -->
                </div><!-- End #header-top -->
			</div>
                <div id="header-inner">
                    <div class="container">
							<div class="header-center">
									<div class="searchform-popup">
										...
										<div class="searchform search_form">
											<fieldset>
												<span class="text">
													<input type="text" name="search" style="color:red;" class="input-block-level search-query" placeholder="<?php echo $search; ?>" required>
												</span>
												<select name="category_id" class="cat" style="color:red">
                        ...
                        <div class="header-right">
								<a href="/index.php?route=account/login"><img src="/image/login.png" height="33px" width="33px"></a>
                        	<?php 
