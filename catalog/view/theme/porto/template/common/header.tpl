...
<head>
	...
	<?php $lista_plikow = array(
			...
			'catalog/view/theme/'.$config->get($config->get('config_theme') . '_directory').'/css/.carousel.css',
    ...
    $lista_plikow[] = 'catalog/view/theme/'.$config->get($config->get('config_theme') . '_directory').'/js/isotope.pkgd.min.js';
...
<div id="wrapper" <?php if($theme_options->get( 'layout_type' ) == 5) { echo 'class="wide-width"';  } ?><?php if($theme_options->get( 'layout_type' ) == 4) { echo 'class="boxed-long"';  } ?><?php if($theme_options->get( 'layout_type' ) == 2) { echo 'class="boxed boxed-short"';  } ?>>
    ...
    <div id="main-content">
		...
		if($theme_options->get( 'header_type' ) == 2) {
			...
			include('catalog/view/theme/'.$config->get($config->get('config_theme') . '_directory').'/template/common/header/header_28.tpl');
		} elseif($theme_options->get( 'header_type' ) == 29) {
			include('catalog/view/theme/'.$config->get($config->get('config_theme') . '_directory').'/template/common/header/header_29.tpl');
		} else {
