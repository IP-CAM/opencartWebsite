...
<link href="catalog/view/theme/<?php echo $templatepath; ?>/stylesheet/nilkanthinfo/animate.css" rel="stylesheet">
...
<header>
  <div class="container">
    <div class="row">
	  ...
	  <div class="search_n_email col-sm-8">
  ...
  <nav id="menu" class="navbar">
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
	  ...
	  <li class="home"> <a href="#"><i class="fa fa-home"></i></a></li>
        ...
        <li class="dropdown"><a href="<?php echo $category['href']; ?>" class="dropdown-toggle" data-toggle="dropdown" class="mainmenu"><?php echo $category['name']; ?></a>
