...
<div class="block container special_block">
	<div class="head_border">
		<h3 class="special_block_heading block_heading"><?php echo $heading_title; ?></h3>
		<div class="head_patern"></div>
	</div>
    			...
    			<div class="product-thumb transition">
					<div class="product-thumb-inner">
						...
						<div class="button-group">
        					...
        					<?php } ?>
							<button class="button_cart button" type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-shopping-cart"></i> 
						...
						<div class="button-group leftrigthcloumn">
								...
								<button  class="button_wishlist button" type="button" data-toggle="tooltip" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product['product_id']; ?>');">
									<i class="fa fa-heart"></i>
								</button>
								<button class="button_compare button" type="button" data-toggle="tooltip" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product['product_id']; ?>');">
