...
<div class="block container latest_block">
	<div class="head_border">
		<h3  class="latest_block_heading block_heading"><?php echo $heading_title; ?></h3>
							...
							<div class="button-group">
								...
								<?php } ?>
			  					<button class="button_cart button" type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-shopping-cart"></i> 
									<span class="hidden-xs hidden-sm hidden-md addtocart"><?php echo $button_cart; ?></span></button>
			  					</div>
			  				<div class="caption">
